 ...
 *
 *
 * // 定义 lib/a 模块 此模块依赖 lib/b 模块
 * // 模块路径是相对 baseUrl 而言的
 * // lib/a 相当于 http://xxx.com/js/lib/a.js
 * define('lib/a', ['lib/b'], function(){
 *     return {a: 111};
 * })
 *
 * // 定义 lib/b 模块 此模块不依赖其他模块
 * define('lib/b', null, function(){
 *     return {b: 222};
 * })
 *
 *
 * // 执行程序 执行过程依赖 lib/a 模块
...
(function(global) {
    ...
    Module.prototype = {
        ...
        ,rebuildDepends: function() {
            ...
            /**
             * [ {id: moduleName, truePath: truePath} ... ]
             */
    ...
    // 兼容 amd
    // 有些库生成的 amd 代码不规范 所以先不兼容
    if(undefined === global.define) {
        global.using = loader.using;
        global.define = loader.define;
        /* global.define = function(id, dep, fun) {
            var len = arguments.length;

            if(1 === len) {
                loader.define('third_' + loader.uuid++, null, id);
            } else if(2 === len) {
                loader.define('third_' + loader.uuid++, id, dep);
            } else if(3 === len) {
                loader.define(id, dep, fun);
            }
        };
